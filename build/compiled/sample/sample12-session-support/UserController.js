...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.getOne = function (user) {
        return user;
    };
    ...
    UserController.prototype.put = function (id, session) {
        session.user = { name: "test", number: id };
    ...
    __decorate([
        Get_1.Get("/users/:id"),
        ContentType_1.ContentType("application/json"),
        __param(0, Session_1.Session("user")),
        __metadata("design:type", Function),
    ...
    __decorate([
        Put_1.Put("/users/:id"),
        __param(0, Param_1.Param("id")), __param(1, Session_1.Session()),
        __metadata("design:type", Function),
